...
PROJECT_ROOT = Path(r"C:\Users\lapto\OneDrive\TERRANOVA\TERRANOVA")
...
def run_ingestion() -> None:
    ...
    declarations_df = fetch_declarations(max_records=1000)
    save_data(declarations_df, "declarations")

    public_assistance_df = fetch_public_assistance(max_records=1000)
